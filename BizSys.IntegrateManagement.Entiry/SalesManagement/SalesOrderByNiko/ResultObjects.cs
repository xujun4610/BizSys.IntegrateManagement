...
namespace BizSys.IntegrateManagement.Entiry.SalesManagement.SalesOrderByNiko
{
    public class ResultObjects : IBaseResultObjects
    {
        ...
        public string ServiceNumberManagementEntry { get; set; }
        public string ServiceNumberManagementLineId { get; set; }
        public string ServiceNumberManagementMoney { get; set; }
